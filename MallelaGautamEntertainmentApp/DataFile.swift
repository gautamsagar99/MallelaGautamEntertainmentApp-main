...
var actor1 = Actor(fullName: "Vijay Devarkonda", yearsActive: "2001 to Present", movies: ["dearcomrade","geethagovindam", "liger", "pellichoopulu", "worldfamouslover"], actorImageName: "https://upload.wikimedia.org/wikipedia/commons/d/d0/Vijay_Deverakonda_at_NOTA_pressmeet_%28cropped%29.jpg", actionEpisodes: "one", dancingSkills: "dancing", performingSkills: "skill", overallRating: 10.0)
...
var actor5 = Actor(fullName: "Allu Arjun", yearsActive: "2001 to Present", movies: ["Sarrainodu","alavaikuntapuram", "DJ", "iddaruammayilatho", "sonofsatyamurthy"], actorImageName:
