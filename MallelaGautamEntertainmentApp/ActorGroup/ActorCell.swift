...
class ActorCell: UITableViewCell {
    ...
    private func defaultAttributes(view: UIView){
        let imageViewHeight = CGFloat(1.0) // You can adjust the margin as per your requirement
           ActorCellIV.frame = CGRect(x: 8, y: 8, width: imageViewHeight, height: imageViewHeight)
        view.frame = CGRect(x: 8, y: 8, width: imageViewHeight, height: imageViewHeight)
